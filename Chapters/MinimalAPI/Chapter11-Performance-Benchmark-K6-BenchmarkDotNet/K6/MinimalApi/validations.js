...
// To run exact this suite in K6 benchmark you need to run the following command being in the project's root directory
// k6 run .\K6\MinimalApi\validations.js --summary-export=.\K6\MinimalApi\Results\validations.json
...
export default function () {
    ...
    let res = http.post("http://localhost:5252/validations", body, { headers: { "Content-Type": "application/json" } });
